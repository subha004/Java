...
class Student1 extends Citizen {
private int rollNo;
private String collegeName;
public Student1() {
super();
}
public Student1(String name, String aadharNo, String address, long phno, int rollNo, String collegeName) {super(name, aadharNo, address, phno); 
...
//Program to demonstrate Single Inheritance 
public class Day5_singleInheritance {
public static void main(String[] args) {
Student1 student = new Student1("Gayatri", "8080808080", "Bangalore", 9888878787L, 10, "City College");
